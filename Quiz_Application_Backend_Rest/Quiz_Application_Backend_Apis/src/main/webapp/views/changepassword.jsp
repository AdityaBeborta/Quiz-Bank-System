...
<div class="mainDiv">
  <div class="cardStyle">
    <form action="/home/processChangePasswordForm" method="post" name="signupForm" id="signupForm">
...
%>
    ...
    <div class="inputDiv">
      ...
      <input type="password" name="newPassword" id="confirmPassword" name="confirmPassword">
