...
body {
  ...
  height: 100vh; align-items: center; /* center horizontally */
  ...
  <form action="/home/addUser" method="post">
    <div class="user__details">
      ...
      <div class="input__box">
        ...
        <input type="text" name="firstName" placeholder="E.g: John Smith" required>
      </div>
      <div class="input__box">
        <span class="details">lastName</span>
        <input type="text" name="lastName" placeholder="E.g: John Smith" required>
      </div>
