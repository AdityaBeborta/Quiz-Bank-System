...
<body>
	...
	<div class="mainDiv">
		<div class="cardStyle">
			<form action="/admin/update/<%=c.getCId()%>" method="post"
				...
				<div class="container text-center">
					...
					<div class="inputDiv">
						<label class="inputLabel" for="password">Title</label>
						<input type="text" id="title" name="title" required value=<%=c.getTitle()%>>
					</div>
